...
var initialExeats = [
  ...
  },
  {
    ...
    notes: 'Needs host family in London. Prefers vegetarian food.',
    parentConfirmation: 'Awaiting',
    prepDeadline: '2026-10-15',
    toDo: 'Find vegetarian host family',
    homestayInfo: 'Smith Family / Room 1',
    hostId: 'HST9901',
    hostName: 'Mr. & Mrs. Smith',
    hostContact: '07700 900 112',
    transportNotes: 'Pick up from school 14:00',
    driverId: 'DRV112',
    driverName: 'Robert Jenkins',
    driverContact: '07700 900 334',
    schoolCalendarLabel: 'Eton Term Dates'
  },
  {
    id: 'EX-007',
    breakType: 'Exeat Weekend',
    ...
    notes: 'Visiting aunt in Manchester.',
    parentConfirmation: 'Confirmed',
    prepDeadline: '2026-11-10',
    toDo: 'Train tickets booked',
    homestayInfo: 'Staying with relatives',
    hostId: '',
    hostName: 'Maria Rossi (Aunt)',
    hostContact: '07700 900 887',
    transportNotes: 'Train from Euston at 17:30',
    driverId: 'DRV113',
    driverName: 'Alan Turing',
    driverContact: '07700 900 998',
    schoolCalendarLabel: 'Harrow Calendar'
  },
  {
    id: 'EX-008',
    breakType: 'Christmas Holiday',
    ...
    notes: 'Returning to Tokyo. Flight via Dubai.',
    parentConfirmation: 'Confirmed',
    prepDeadline: '2026-12-05',
    toDo: 'Send boarding pass to parents',
    homestayInfo: 'N/A',
    hostId: '',
    hostName: 'None',
    hostContact: 'N/A',
    transportNotes: 'Heathrow T3 Departure 20:00',
    driverId: 'DRV114',
    driverName: 'Emily Clark',
    driverContact: '07700 900 115',
    schoolCalendarLabel: 'Winchester Term'
  },
  {
    id: 'EX-009',
    breakType: 'Spring Half Term',
    ...
    notes: 'Needs intensive math tutoring during break.',
    parentConfirmation: 'Confirmed',
    prepDeadline: '2027-01-28',
    toDo: 'Coordinate with tutor',
    homestayInfo: 'Williams Family (Tutor)',
    hostId: 'HST9902',
    hostName: 'Williams Family',
    hostContact: '07700 900 445',
    transportNotes: 'Drop off at Oxford city center',
    driverId: 'DRV115',
    driverName: 'David Lee',
    driverContact: '07700 900 667',
    schoolCalendarLabel: 'Radley Spring Term'
  },
  {
    id: 'EX-010',
    breakType: 'Easter Holiday',
    ...
    duration: 20,
    returnDate: '2027-04-14',
    notes: 'Parents visiting UK. Staying at London hotel.',
    parentConfirmation: 'No — family self-managing, no help required',
    prepDeadline: '2027-03-15',
    toDo: 'Log hotel address for safeguarding',
    homestayInfo: 'Ritz Hotel London',
    hostId: '',
    hostName: 'Parents (Mr. Khan)',
    hostContact: '+44 7700 900 123',
    transportNotes: 'Self-arranged taxi',
    driverId: '',
    driverName: 'Self Arranged',
    driverContact: 'N/A',
    schoolCalendarLabel: 'Abingdon Easter'
  },
  {
    id: 'EX-011',
    breakType: 'Exeat Weekend',
    ...
    duration: 2,
    returnDate: '2026-11-22',
    notes: 'Dog allergy. Needs pet-free homestay.',
    parentConfirmation: 'Awaiting',
    prepDeadline: '2026-11-05',
    toDo: 'Confirm allergy requirements',
    homestayInfo: 'Taylor Family / Pet-free',
    hostId: 'HST9903',
    hostName: 'Taylor Family',
    hostContact: '07700 900 551',
    transportNotes: 'Driver to pick up at 16:30',
    driverId: 'DRV116',
    driverName: 'Sarah Bennett',
    driverContact: '07700 900 558',
    schoolCalendarLabel: 'Headington Calendar'
  },
  {
    id: 'EX-012',
    breakType: 'Autumn Half Term',
    studentId: 'STU45645',
    studentName: 'Omar Al-Fayed',
    schoolName: 'Charterhouse',
    startDate: '2026-10-18',
    duration: 15,
    returnDate: '2026-11-02',
    notes: 'Needs Halal food options.',
    parentConfirmation: 'Confirmed',
    prepDeadline: '2026-10-10',
    toDo: 'Notify host about diet',
    homestayInfo: 'Rahman Family',
    hostId: 'HST9904',
    hostName: 'Rahman Family',
    hostContact: '07700 900 772',
    transportNotes: 'School bus to Waterloo',
    driverId: '',
    driverName: 'School Bus',
    driverContact: 'N/A',
    schoolCalendarLabel: 'Charterhouse Dates'
  },
  {
    id: 'EX-013',
    breakType: 'Christmas Holiday',
    studentId: 'STU78978',
    studentName: 'Chloe Davies',
    schoolName: 'Wellington College',
    startDate: '2026-12-12',
    duration: 26,
    returnDate: '2027-01-07',
    notes: 'Ski trip with school for first week, then homestay.',
    parentConfirmation: 'Confirmed',
    prepDeadline: '2026-11-30',
    toDo: 'Book homestay for 2nd week',
    homestayInfo: 'Brown Family',
    hostId: 'HST9905',
    hostName: 'Brown Family',
    hostContact: '07700 900 993',
    transportNotes: 'Return from Geneva on 19th',
    driverId: 'DRV117',
    driverName: 'Gary Neville',
    driverContact: '07700 900 224',
    schoolCalendarLabel: 'Wellington Term'
  },
  {
    id: 'EX-014',
    breakType: 'Spring Half Term',
    studentId: 'STU13579',
    studentName: 'Lukas Muller',
    schoolName: 'Tonbridge School',
    startDate: '2027-02-14',
    duration: 7,
    returnDate: '2027-02-21',
    notes: 'Attending music camp.',
    parentConfirmation: 'Confirmed',
    prepDeadline: '2027-02-05',
    toDo: 'Coordinate instrument transport',
    homestayInfo: 'Music Camp Dorms',
    hostId: '',
    hostName: 'Camp Organizer',
    hostContact: '07700 900 335',
    transportNotes: 'Needs large taxi for Cello',
    driverId: 'DRV118',
    driverName: 'Paul Scholes',
    driverContact: '07700 900 446',
    schoolCalendarLabel: 'Tonbridge Spring'
  },
  {
    id: 'EX-015',
    breakType: 'Easter Holiday',
    studentId: 'STU24680',
    studentName: 'Harper Wood',
    schoolName: 'Marlborough College',
    startDate: '2027-03-24',
    duration: 22,
    returnDate: '2027-04-15',
    notes: 'Staying with guardian for full break.',
    parentConfirmation: 'Confirmed',
    prepDeadline: '2027-03-10',
    toDo: 'Confirm room readiness',
    homestayInfo: 'Guardian Home',
    hostId: 'HST9906',
    hostName: 'Oxford Guardians HQ',
    hostContact: '01865 123456',
    transportNotes: 'Pick up by guardian staff',
    driverId: 'DRV119',
    driverName: 'Admin Staff',
    driverContact: '01865 123456',
    schoolCalendarLabel: 'Marlborough Easter'
  }
];

function initExeatDB() {
  localStorage.removeItem(OG_EXEATS_KEY);
